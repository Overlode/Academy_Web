            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">发布成功</h3>
                    </div>
        ...
        <div class="col-lg-8">
            <div>
                <ul class="nav nav-tabs nav-justified">
                    <li class="active"><a href="/management-1">公告发布</a></li>
            ...
            <div>
                <form role="form" id="newContext" action="/managementcontrol" method="post"   target="frameName">
                    <input type="number" class="form-control" name="controlType" style="display: none" value="1">
                    <div class="form-group">
                        <label>标题</label>
                        <input type="text" class="form-control" placeholder="标题" name="headline">
                    </div>
                    <div class="form-group">
                        <label>详细内容</label>
