    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div>
                <ul class="nav nav-pills nav-stacked" style="padding: 0;margin: 0;border: 0;">
                    <c:forEach items="${newsList}" var="n" begin="${(page-1)*10}" end="${(page*10)-1}"
                        ...
                        <li><a href="/management-2-alter?nid=${n.newsid}">${n.head}</a></li>
            ...
            <div class="buttonBtn">
                <ul class="pager">
                <c:if test="${page>1}">
                    <li class="previous"><a href="/management-2?page=${page-1}">上一页</a></li>
                </c:if>
                <c:if test="${page==1}">
                    <li class="previous disabled"><a href="/management-2?page=${page}">上一页</a></li>
                </c:if>
                <c:if test="${count>=10}">
                    <li class="next"><a href="/management-2?page=${page+1}">下一页</a></li>
                </c:if>
                <c:if test="${count<10}">
                    <li class="next disabled"><a href="/management-2?page=${page}">下一页</a></li>
                </c:if>
                </ul>
            </div>
        </div>
